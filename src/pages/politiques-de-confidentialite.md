...
- **Nom et prénom** (via le formulaire de contact et la prise de rendez-vous) ;
- **Adresse email** (via le formulaire de contact et la prise de rendez-vous) ;
- **Numéro de téléphone** (optionnel, via le formulaire de contact et la prise de rendez-vous) ;
- **Message ou demande** (via le formulaire de contact) ;
...
- Gérer les réservations et envoyer des confirmations de rendez-vous ;
...
Les données personnelles peuvent être partagées avec les services tiers suivants :

- **Cal.com** : Gestion des réservations et prises de rendez-vous en ligne. Données collectées : nom, prénom, adresse email, numéro de téléphone, détails des rendez-vous. [Politique de confidentialité](https://cal.com/privacy).
- **Formulaire de contact** : Traitement des demandes de contact et devis. Données collectées : nom, prénom, adresse email, numéro de téléphone, message. (traitement interne, aucune transmission à des tiers).
- **Google Analytics** : Analyse statistique du trafic et mesure d'audience. Données collectées : adresse IP anonymisée, données de navigation (pages visitées, durée des sessions). [Politique de confidentialité](https://policies.google.com/privacy).
...
- Adresse email : 12 mois après la fin de la campagne de lancement ;
